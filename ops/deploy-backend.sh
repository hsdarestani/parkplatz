...
sed -i 's/^TRUST_SUPPORT_EMAIL=info@aplus-solution\.de$/TRUST_SUPPORT_EMAIL=parkplat@aplus-solution.de/' .env.production
sed -i 's/^SMTP_FROM_EMAIL=info@aplus-solution\.de$/SMTP_FROM_EMAIL=parkplat@aplus-solution.de/' .env.production
for setting in \
  'PRIMARY_EMAIL=parkplat@aplus-solution.de' \
  'NOMINATIM_CONTACT_EMAIL=parkplat@aplus-solution.de' \
